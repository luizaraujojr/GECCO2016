	...
	#gaNoError <- read.table(file="C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/basedata/nsga/150k/nsga_150k_c50_2x_error1_frontier_obj.txt", header=TRUE);
	...
	cpm <- read.table(file="C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/basedata/oms/CPM_error1_frontier_obj.txt", header=TRUE);
	margarine <- read.table(file="C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/basedata/oms/Margarine_error1_frontier_obj.txt", header=TRUE);
	sh <- read.table(file="C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/basedata/oms/SecondHalf_error1_frontier_obj.txt", header=TRUE);
	...
	#gaOvertime <- read.table(file="C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/base/rq4/nsga_error1.txt", header=TRUE);
	...
	plot.my.chart <- function(xo, yo, xe, ye, xc, yc, xm, ym, xs, ys, xTitle, yTitle, instanceName) {
		...
		lines(xe, ye, type="p", col="dark gray", cex=0.5, pch="o");# NSGANE

		lines(xc, yc, type="p", col="black", pch=3);#cpm
		#text(xc, yc, "C");

		lines(xm, ym, type="p", col="black", pch="O");#mar
		#text(xm, ym, "M");

		lines(xs, ys, type="p", col="black", pch=2);#sh
		#text(xs, ys, "S");
	}
	
	pdf("E:/Backup/Documentos/GitHub/Hector/data/result/Dissertacao/analysis/consolidado/boxplot_ACAD_PARM.pdf", width=10, height=4)

	# Plot 3D faces for all instanceNames
	#pdf("C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/analysis/boxplot geral/faces-3d0.pdf", width=10, height=16)
	#"C:/Users/luiz/Documents/GitHub/Hector/data/result/dissertacao/analysis/boxplot geral/faces-3d1.pdf"
	#windows(14, 10);
	par(mfrow=c(2, 3))
