...
public class TestScenarioOverworking extends TestCase 
{
	...
	public void testAll() throws Exception
	{
		...
		assertEquals(2.7, project.getActivity("Requisitos Disciplinas").getStartExecutionTime(), 0.1);	
		assertEquals(3.5, project.getActivity("Requisitos Disciplinas").getFinishingTime(), 0.1);	
		assertEquals(9.6, project.getActivity("Requisitos Disciplinas").getErrors(), 0.1);	

		assertEquals(3.5, project.getActivity("Requisitos Aluno").getStartExecutionTime(), 0.1);	
		assertEquals(4.4, project.getActivity("Requisitos Aluno").getFinishingTime(), 0.1);	
		assertEquals(11.0, project.getActivity("Requisitos Aluno").getErrors(), 0.1);	
		
		assertEquals(4.4, project.getActivity("Requisitos Áreas").getStartExecutionTime(), 0.1);	
		...
		assertEquals(20.8, project.getActivity("Codificacao Inscrições").getFinishingTime(), 0.1);	
		assertEquals(97.2, project.getActivity("Codificacao Inscrições").getErrors(), 0.1);	
		
		assertEquals(20.8, project.getActivity("Codificacao Turmas").getStartExecutionTime(), 0.1);	
		assertEquals(29.3, project.getActivity("Codificacao Turmas").getFinishingTime(), 0.1);	
		assertEquals(147.6, project.getActivity("Codificacao Turmas").getErrors(), 0.1);	
		
		assertEquals(29.3, project.getActivity("Codificacao Disciplinas").getStartExecutionTime(), 0.1);	
		assertEquals(33.4, project.getActivity("Codificacao Disciplinas").getFinishingTime(), 0.1);	
		assertEquals(72.0, project.getActivity("Codificacao Disciplinas").getErrors(), 0.1);	
		
		assertEquals(33.4, project.getActivity("Codificacao Aluno").getStartExecutionTime(), 0.1);	
		assertEquals(38.1, project.getActivity("Codificacao Aluno").getFinishingTime(), 0.1);	
		assertEquals(82.8, project.getActivity("Codificacao Aluno").getErrors(), 0.1);	
		
		assertEquals(38.1, project.getActivity("Codificacao Áreas").getStartExecutionTime(), 0.1);	
		assertEquals(42.9, project.getActivity("Codificacao Áreas").getFinishingTime(), 0.1);	
		assertEquals(82.8, project.getActivity("Codificacao Áreas").getErrors(), 0.1);	
		
		assertEquals(42.9, project.getActivity("Codificacao Professores").getStartExecutionTime(), 0.1);	
		assertEquals(47.0, project.getActivity("Codificacao Professores").getFinishingTime(), 0.1);	
		assertEquals(72.0, project.getActivity("Codificacao Professores").getErrors(), 0.1);	
		
		assertEquals(47.0, project.getActivity("Codificacao Usuários").getStartExecutionTime(), 0.1);	
		assertEquals(50.7, project.getActivity("Codificacao Usuários").getFinishingTime(), 0.1);	
		assertEquals(64.8, project.getActivity("Codificacao Usuários").getErrors(), 0.1);	
		
		assertEquals(50.7, project.getActivity("Testes Inscrições").getStartExecutionTime(), 0.1);	
		assertEquals(59.1, project.getActivity("Testes Inscrições").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Inscrições").getErrors(), 0.1);	
		
		assertEquals(59.1, project.getActivity("Testes Turmas").getStartExecutionTime(), 0.1);	
		assertEquals(71.9, project.getActivity("Testes Turmas").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Turmas").getErrors(), 0.1);	
		
		assertEquals(71.9, project.getActivity("Testes Disciplinas").getStartExecutionTime(), 0.1);	
		assertEquals(78.2, project.getActivity("Testes Disciplinas").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Disciplinas").getErrors(), 0.1);	
		
		assertEquals(78.2, project.getActivity("Testes Aluno").getStartExecutionTime(), 0.1);	
		assertEquals(85.3, project.getActivity("Testes Aluno").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Aluno").getErrors(), 0.1);	
		
		assertEquals(85.3, project.getActivity("Testes Áreas").getStartExecutionTime(), 0.1);	
		assertEquals(92.5, project.getActivity("Testes Áreas").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Áreas").getErrors(), 0.1);	
		
		assertEquals(92.5, project.getActivity("Testes Professores").getStartExecutionTime(), 0.1);	
		assertEquals(98.8, project.getActivity("Testes Professores").getFinishingTime(), 0.1);	
		assertEquals(0.0, project.getActivity("Testes Professores").getErrors(), 0.1);	
		
		assertEquals(98.8, project.getActivity("Testes Usuários").getStartExecutionTime(), 0.1);	
		assertEquals(104.4, project.getActivity("Testes Usuários").getFinishingTime(), 0.1);	
