...
#data <- read.table(file="/Users/Marcio/Desktop/Codigos/Hector/data/result/Analysis/oms/data.txt", header=TRUE);

# Load data - micro do Luiz
 data <- read.table(file="C:/workspace/Hector/data/result/Analysis/oms/data.txt", header=TRUE);
